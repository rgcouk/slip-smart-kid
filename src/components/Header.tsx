    ...
    <header className="bg-card border-b border-gray-200 shadow-sm">
      <div className="container mx-auto section-padding py-4 flex items-center justify-between">
        <div className="flex items-center gap-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <Badge className="ml-2 bg-primary text-primary-foreground text-xs px-2 py-1">Pro</Badge>
            </div>
          </div>
        ...
        <div className="flex items-center gap-4">
          {user && (
            <div className="hidden md:flex items-center gap-4">
              ...
              <Button
                ...
                className="formaslips-button flex items-center gap-2 touch-target-48"
              >
          ...
          {!user && (
            <div className="flex items-center gap-3">
              <Button variant="ghost" size="sm" className="formaslips-button touch-target-48" asChild>
                <a href="/auth">Sign In</a>
              </Button>
              <Button size="sm" className="formaslips-button touch-target-48" asChild>
