...
export const BusinessSetupStep = ({ payslipData, setPayslipData, isParentMode }: BusinessSetupStepProps) => {
        ...
        <Collapsible open={companyExpanded} onOpenChange={setCompanyExpanded}>
          <CollapsibleTrigger className="w-full">
            <div className="bg-white border border-gray-200 rounded-lg p-4 shadow-sm hover:shadow-md transition-shadow">
              ...
              {!companyExpanded && payslipData.companyName && (
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-4 mt-2 space-y-4">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => setPayslipData(prev => ({ ...prev, companyName: e.target.value }))}
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => setPayslipData(prev => ({ ...prev, companyAddress: e.target.value }))}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setPayslipData(prev => ({ ...prev, companyPhone: e.target.value }))}
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setPayslipData(prev => ({ ...prev, companyEmail: e.target.value }))}
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => setPayslipData(prev => ({ ...prev, companyRegistration: e.target.value }))}
              ...
              <div>
                ...
                <RadioGroup 
                  ...
                  onValueChange={(value: 'default' | 'professional') => 
                    setPayslipData(prev => ({ ...prev, template: value }))
                  }
                >
        ...
        <Collapsible open={employeeExpanded} onOpenChange={setEmployeeExpanded}>
          <CollapsibleTrigger className="w-full">
            <div className="bg-white border border-gray-200 rounded-lg p-4 shadow-sm hover:shadow-md transition-shadow">
              ...
              {!employeeExpanded && payslipData.name && (
                <div className="mt-2 text-sm text-gray-600">
